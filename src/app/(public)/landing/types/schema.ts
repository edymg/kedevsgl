...
export const countries: readonly Countries[] = [
...
export const optionPay = [
	...
	{ id: '1', label: 'Si, mi empresa podría invertir esos valores.' },
	{ id: '2', label: 'Podría abonar cuotas para el desarrollo.' },
	{ id: '3', label: 'No puedo invertir en mi proyecto.' },
...
const phoneSchema = z
	...
	.refine((phone) => {
		...
		message: "Must be a valid phone number (min 5 digits)",
	});

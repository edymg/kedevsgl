    ...
    <section>
      <div className="container mx-auto px-4 py-16 md:py-20 font-montserrat">
        <div className="max-w-4xl mx-auto">
          <motion.h2
            className="text-2xl md:text-3xl font-bold text-center text-white mb-4 sm:mb-12"
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {risks.map((risk, index) => (
              <div
                key={index}
                className="flex gap-4 p-6 rounded-lg bg-blue-found/60 border border-red-600/50"
              >
